  ...
  return (
    <div
      style={{
        ...
        // The background covers the entire fixed viewport via background-attachment
        // We use a pseudo approach: background on this element covers visible area,
        // and we use a separate fixed pseudo-element via ::before trick via an inner div
      }}
    >
      {/* Fixed backdrop that always covers the screen regardless of scroll */}
      <div style={{
        position: 'fixed',
        inset: 0,
